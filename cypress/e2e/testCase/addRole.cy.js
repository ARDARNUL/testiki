describe("Cypress tests", () => {
    ...
    //         cy.get('.form-input--password').type("123fsdfasd123!")
    ...
    //         cy.log("Выбираем университет вбивая значения ТУСУР")
    ...
    //             .should("contain", "Верификация аккаунта с прикреплением к ТУСУР по адресу ")
    //     })
    // })
